...
# -*- coding: utf-8 -*-
"""
YYC3-Cater-项目文档架构一键创建脚本
功能：自动生成符合规范的全量文档目录及.md文件
遵循规范：01-YYC3-Cater--[文档类型]-[具体名称].md
...
def create_doc_structure():
    ...
    """
    try:
        print("🚀 开始执行YYC3-Cater-项目文档架构创建脚本...")
        # 1. 创建根目录
        ...
        for stage_name, doc_types in DOC_STRUCTURE.items():
            ...
            for doc_type, doc_names in doc_types.items():
                ...
                for idx, doc_name in enumerate(doc_names, start=1):
                    # 生成文件名：01-YYC3-Cater--[文档类型]-[具体名称].md
                    file_name = f"{idx:02d}-YYC3-Cater--{doc_type}-{doc_name}.md"
